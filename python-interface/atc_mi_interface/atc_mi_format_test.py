    ...
    # reference_label and key_label must be set in ConstructGallery
        [
            (
                "custom",
                {
                    "binary": bytes.fromhex(
                        "1a 18 cc bb aa 38 c1 a4 6c 07 fa 13 d6 0a 52 09 0f"),
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1a 18 bd 86 c5 3f fa b9 00 c1 51 58 59"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1a 18 a4 c1 38 aa bb cc 00 ce 33 43 0a 6e c3"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 50 58 5b 05 1b cc bb aa 38 c1 a4 0d 10 04 "
                        "be 00 00 02"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 50 58 5b 05 22 cc bb aa 38 c1 a4 0a 10 01 4f"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 30 58 5b 05 cc cc bb aa 38 c1 a4 08"
                    ),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 58 58 5b 05 f4 cc bb aa 38 c1 a4 13 df 92 "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 58 58 5b 05 95 cc bb aa 38 c1 a4 d5 25 d9 "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 58 58 5b 05 ed cc bb aa 38 c1 a4 de 6d f0 "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "95 fe 58 59 63 08 18 cc bb aa 44 ef 54 ce ce 8a "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1c 18 02 00 56 23 02 6c 07 03 03 ff 13 02 01 4e"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1c 18 02 00 63 02 10 01 03 0c d9 0a"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1c 18 02 01 61 23 02 ca 09 03 03 bf 13 02 2e 23 "
                        ...
                        "01 0d 53 48 65 6c 6c 6f 20 57 6f 72 6c 64 21 0d 54 48 "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1e 18 83 93 db a2 55 4c d8 04 be ab 78 cf b3 00 "
                        "00 7d 6a 1c d2"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "1e 18 12 79 94 44 eb 3a 3f e4 b3 00 00 59 62 3a 29"),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "d2 fc 40 00 d6 01 50 02 80 07 03 8a 13"
                    ),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "d2 fc 40 00 01 51 87 56 01 61 12 e2 04 09 60 3d "
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "d2 fc 41 95 b0 ef da 78 9d d9 53 b0 26 00 00 "
                        "93 41 62 6f"
                    ),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ...
            (
                ...
                {
                    "binary": bytes.fromhex(
                        "d2 fc 41 d4 6c c8 e7 74 b9 26 00 00 cb d8 4a 40"
                    ),
                    "mac_address": "A4:C1:38:AA:BB:CC",
                },
            ),
